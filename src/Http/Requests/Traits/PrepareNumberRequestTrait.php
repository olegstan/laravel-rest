...
trait PrepareNumberRequestTrait
{
     ...
     * @var array
     *
     * переменная используется для преобразования входных данных
     * цифра 1 000 000, будет преобразована в 1000000
     * можно указывать название поля sum, так и ключи в массивах accounts.*.sum
     */
